...
uint256 hashGenesisBlock("0xd1bea1bb92bd7e76f51cad971b182c448aac1e074f01f01ae11d1df40d8eaca6");
...
const string strMessageMagic = "skatecoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // skatecoin: 1 days
static const int64 nTargetSpacing = 120; // skatecoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal skatecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "skatecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3856995d7718034ae7888f10333ac3c29c220f04ab376e8323f532f261102ad6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Sk8Coin - Simple is better.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394767314; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4742294;

        if (fTestNet)
        {
            block.nTime    = 1300000000;
            block.nNonce   = 1235105;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6ec312805bbc53a9c5dd44dc444ec244518a8f2e0837c858b0a167e8827fa490"));
