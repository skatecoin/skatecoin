...
uint256 hashGenesisBlock("0x1f2680ad9afb262eb3b2709024fe9037b62bf612546291241bcb66d046c80376");
...
static const int64 nTargetTimespan = 2400; // skatecoin: 1 days
static const int64 nTargetSpacing = 40; // skatecoin: 2 minute blocks
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc1e342b8df3dab32c8b7e62984e07696256dc392421623af452a514f264d618f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "SKATE AND DESTROY!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395787648; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 5151579;

        if (fTestNet)
        {
            block.nTime    = 1300000000;
            block.nNonce   = 1340458;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb1a54401b9f13d0956a0ae12cda51dfd05d8c2360164128d553b110009839294"));
